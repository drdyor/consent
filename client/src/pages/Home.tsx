...
export default function Home() {
  ...
  if (workspace.error) return <main className="workspace-page"><section className="clinical-panel max-w-2xl p-8"><p className="metric-label">Protected clinic workspace</p><h1 className="serif mt-2 text-4xl font-semibold text-[#24453e]">Sign in to access your consent studio.</h1><p className="mt-3 text-sm leading-relaxed text-muted-foreground">Clinic records, template controls, source documents, and patient information are available only to authenticated clinic staff.</p><button onClick={() => startLogin()} className="mt-6 rounded-xl bg-[#24453e] px-4 py-3 text-sm font-semibold text-white">Sign in securely</button></section></main>;
  return (
