...
export const clinics = mysqlTable("clinics", {
  ...
  complianceMarket: mysqlEnum("complianceMarket", ["pl_eu", "uk_gb", "usa"]).default("pl_eu").notNull(),
...
export const marketCatalogueProducts = mysqlTable("marketCatalogueProducts", {
  ...
  category: mysqlEnum("category", ["neuromodulator", "ha_filler", "biostimulator", "polynucleotide", "lipolysis", "medical_device", "other"]).notNull(),
...
export const consentTemplates = mysqlTable("consentTemplates", {
  ...
  requiresProduct: boolean("requiresProduct").default(true).notNull(),
...
export const consentRecords = mysqlTable("consentRecords", {
  ...
  productId: int("productId").references(() => products.id),
  sourceId: int("sourceId").references(() => productSources.id),
