...
describe("consent signing controls", () => {
  ...
  it("hashes the complete signing snapshot, including clinic, practitioner, source, and signature data", () => {
    ...
    expect(first.snapshot).toMatchObject({ educationResources: [{ publisher: "NICE", canonicalUrl: "https://www.nice.org.uk/example", sourceVersion: "2026-08", jurisdiction: "GB", language: "en" }] });
