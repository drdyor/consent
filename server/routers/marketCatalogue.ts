...
const catalogueFilter = z.object({ category: z.enum(["all", "neuromodulator", "ha_filler", "biostimulator", "polynucleotide", "lipolysis", "dental_implant", "dental_graft", "dental_membrane", "dental_prosthetic", "dental_other", "other"]).default("all"), researchStatus: z.enum(["all", "research", "needs_evidence", "curation_ready", "restricted"]).default("all") });
