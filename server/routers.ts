...
import { educationGovernanceRouter } from "./routers/educationGovernance";
import { aiGovernanceRouter } from "./routers/aiGovernance";
...
export const appRouter = router({
  ...
  educationGovernance: educationGovernanceRouter,
