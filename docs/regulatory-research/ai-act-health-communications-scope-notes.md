...
| Human oversight | The AI Act Service Desk’s Article 14 summary describes effective natural-person oversight for high-risk systems, with monitoring, interpretation, override capability and attention to over-reliance; the summary itself is not legally binding. [10] | Aegis adopts a narrower operational control: AI assistance is non-authoritative until a named human separately appends an approval or rejection event. This is a governance method, not a classification determination. |
| AWS vendor reference | AWS states that its materials are intended to support customers’ assessment and that customers remain responsible for assessing their own AI activities and implementing appropriate controls. [11] | The identified AWS post is useful vendor context only. It does not establish Aegis’s legal position, provider suitability, data-processing terms, or an AI Act classification. Official sources and qualified review govern any claim. |
...
[10] [AI Act Service Desk, *Article 14: Human oversight*](https://ai-act-service-desk.ec.europa.eu/en/ai-act/article-14)

[11] [AWS Machine Learning Blog, *Building trust in AI: The AWS approach to the EU AI Act*](https://aws.amazon.com/blogs/machine-learning/building-trust-in-ai-the-aws-approach-to-the-eu-ai-act/)
